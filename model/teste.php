...
require_once 'concessionaria.class.php';
require_once 'alocacao.class.php';
...
if ($resultado) {
    echo "Concessionária encontrada:<br>";
    echo "ID: " . $resultado['id_concessionaria'] . "<br>";
    echo "Nome: " . $resultado['concessionaria'] . "<br>";
} else {
